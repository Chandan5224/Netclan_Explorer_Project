 ...
 * Use the [ProfessionalFrag.newInstance] factory method to
 * create an instance of this fragment.
 */
class ProfessionalFrag : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment ProfessionalFrag.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ProfessionalFrag().apply {
